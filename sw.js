const CACHE='fieldready-study-v4.1.1';
const ASSETS=['./','./index.html','./styles.css','./version.js','./access-config.js','./locations.js','./skills.js','./app.js','./manifest.webmanifest','./assets/icon.svg'];
