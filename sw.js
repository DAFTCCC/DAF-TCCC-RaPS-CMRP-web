const CACHE='fieldready-study-v4.2.0';
const ASSETS=['./','./index.html','./styles.css','./version.js','./access-config.js','./backend-config.js','./locations.js','./skills.js','./sync.js','./app.js','./manifest.webmanifest','./assets/icon.svg'];
